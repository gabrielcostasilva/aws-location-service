...
// AWS Resources
// Cognito:
const identityPoolId = "IDENTITY-POOL-ID-HERE";

// Amazon Location Service resource names:
const mapName = "cloud-formation-map";
const placesName = "cloud-formation-index";
...
async function initializeMap() {
  ...
  const mlglMap = new maplibregl.Map({
    ...
    center: [-51.94306999999998, -23.421289999999942], // Initial map centerpoint
